...
class GameStateCorrect(GameStateFormatV2):
    ...
    def __init__(self, board: tuple[int, ...] | None = None, white_queen: bool = True, white_king: bool = True,
        ...
        """
        Initialize a GameStateCorrect object.
        ...
        """
        self.moves_and_states: list[tuple[tuple[int, int, int], GameStateCorrect]] | None = None
    ...
    def get_moves(self) -> list[tuple[int, int, int]]:
        ...
        if len(moves) == 0 and pop_idx_base > -1:
            game_state: GameStateCorrect = GameStateCorrect(self.board, False, False, False,
    ...
    def get_moves_new(self) -> list[tuple[tuple[int, int, int], 'GameStateCorrect']]:  # type: ignore
        """
        Get all the possible moves for the current player.
        ...
        moves_and_states: list[tuple[tuple[int, int, int], GameStateCorrect]] = []
        for i, move in enumerate(reversed(moves)):
            state: GameStateCorrect = self.move(move)
    ...
    def get_new_states(self) -> list[tuple[tuple[int, int, int], 'GameStateCorrect']]:
        """
        Get all the possible moves for the current player.
    ...
    def move(self, move: tuple[int, int, int]) -> 'GameStateCorrect':
        ...
        return GameStateCorrect(tuple(new_board), white_queen, white_king, black_queen, black_king, last_move=last_move,
                           color=-self.color, turn=self.turn + 1, moves_since_pawn=new_moves_since_pawn,
    ...
    def __repr__(self) -> str:
        return f"""GameStateCorrect(board={self.board}
          color={self.color},
          turn={self.turn},
          winner={self.winner},
